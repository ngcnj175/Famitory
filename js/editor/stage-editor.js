            ...
            const startLongPress = () => {
                ...
                longPressTimer = setTimeout(() => {
                    ...
                    App.showActionMenu(null, [
                        { text: this.t('U286'), action: () => this.duplicateTemplate(index) },
                        { text: this.t('U287'), style: 'destructive', action: () => this.deleteTemplate(index, false) },
                        { text: this.t('U288'), style: 'cancel' }
                    ]);
                }, 800);
            };
