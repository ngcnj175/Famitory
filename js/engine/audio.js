...
const NesAudio = {
    ...
    playSE_attack_03() { this.playUnifiedSE({ waveType: 'sawtooth', envelopeMode: 'adsr', sustainTime: 0.12, decayTime: 0.125, masterVolume: 0.14, frequencyStart: 1054, duty: 0.125, frequencySlide: -1472, vibratoDepth: 21, vibratoSpeed: 21, pitchJump1Amount: -100, pitchJump1Onset: 0.36, pitchJump2Amount: 150, pitchJump2Onset: 0.7 }); },
    ...
    playSE_attack_06() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'legacy4step', sustainTime: 0.1, decayTime: 0.175, masterVolume: 0.35, frequencyStart: 618, duty: 0.25, frequencySlide: -648, pitchJump1Amount: -350, pitchJump1Onset: 0.28, pitchJump2Amount: 110, pitchJump2Onset: 0.58, notes: [{ freq: 514, duration: 0.06, spacing: 0.031 }, { freq: 965, duration: 0.054 }] }); },
    playSE_attack_07() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'legacy4step', sustainTime: 0.055, decayTime: 0.12, masterVolume: 0.2, frequencyStart: 963, frequencySlide: 128, vibratoDepth: 22, vibratoSpeed: 13.5, pitchJump1Amount: 200, pitchJump1Onset: 0.3 }); },
    ...
    playSE_damage_03() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'legacy4step', sustainTime: 0.17, decayTime: 0.12, masterVolume: 0.26, frequencyStart: 590, frequencySlide: -441, pitchJump1Amount: 160, pitchJump1Onset: 0.18 }); },
    ...
    playSE_damage_09() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'legacy4step', sustainTime: 0, decayTime: 0.195, masterVolume: 0.1, frequencyStart: 20, frequencySlide: -3000, pitchJump1Amount: -90, pitchJump1Onset: 0.28, notes: [{ freq: 390, duration: 0.065 }, { freq: 841, duration: 0.03 }, { freq: 783, duration: 0.104, spacing: 0.02 }] }); },
    ...
    playSE_explosion_03() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'adsr', sustainTime: 0.24, decayTime: 0.22, masterVolume: 0.39, frequencyStart: 700, duty: 0.25, frequencySlide: -184, vibratoDepth: 30, vibratoSpeed: 7.5, pitchJump1Amount: -620, pitchJump1Onset: 0.04 }); },
    playSE_explosion_04() { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'adsr', sustainTime: 0.15, decayTime: 0.32, masterVolume: 0.18, frequencyStart: 20, frequencySlide: 921, vibratoDepth: 138, vibratoSpeed: 19.5, repeatCount: 3 }); },
    ...
    playSE_pause_02()     { this.playUnifiedSE({ waveType: 'square', envelopeMode: 'legacy4step', sustainTime: 0.055, decayTime: 0.12, masterVolume: 0.2, frequencyStart: 963, frequencySlide: 128, vibratoDepth: 22, vibratoSpeed: 13.5, pitchJump1Amount: 200, pitchJump1Onset: 0.3 }); },
